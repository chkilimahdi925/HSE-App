    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.card}>
          ...
          <InfoRow icon="business-outline" label="Entreprise" value={user?.company?.name || user?.company} />
...
const styles = StyleSheet.create({
  ...
  avatarSection: { alignItems: 'center', paddingVertical: 32, backgroundColor: COLORS.primary },
  avatar: {
  ...
  card: {
    backgroundColor: COLORS.white, margin: 16, borderRadius: 14, padding: 16, ...SHADOWS.small,
  },
