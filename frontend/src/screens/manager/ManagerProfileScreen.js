      ...
      <ScrollView>
        <View style={styles.avatarSection}>
          ...
          <View style={styles.roleBadge}>
            ...
            <Text style={styles.roleText}>HSE MANAGER</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  avatarSection: { alignItems: 'center', paddingVertical: 32, backgroundColor: '#16A085' },
  avatar: {
  ...
  roleBadge: {
    ...
    backgroundColor: 'rgba(0,0,0,0.15)', paddingHorizontal: 14, paddingVertical: 5, borderRadius: 20,
  },
  roleText: { fontSize: 12, fontWeight: '700', color: COLORS.white, letterSpacing: 1 },
  card: { backgroundColor: COLORS.white, margin: 16, borderRadius: 14, padding: 16, ...SHADOWS.small },
  ...
  infoIcon: { width: 36, height: 36, borderRadius: 10, backgroundColor: COLORS.primary + '12', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  infoContent: { flex: 1 },
  infoLabel: { fontSize: 11, color: COLORS.textLight, marginBottom: 2 },
  infoValue: { fontSize: 14, fontWeight: '600', color: COLORS.textPrimary },
  logoutBtn: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10,
    backgroundColor: COLORS.danger, margin: 16, borderRadius: 12, paddingVertical: 14,
  },
